...
const PROVIDERS = {
  ...
  xiaomi: { name: 'Xiaomi', color: '#FF6900', logo: 'Xi' },
  inception: { name: 'Inception', color: '#8B5CF6', logo: 'Ic' },
};
...
const MODELS = [
  ...
  },
  {
    ...
    scores: {
      ...
      vellum: { hle: 57.9, gpqa: 93.6, swebench: 88.6, autobench: 15.5, osworld: 83.4, browsecomp: null, terminal: 74.6 },
  ...
  // === NEW MODELS (July 2026) ===
  {
    ...
    maxOutput: 128000,
    license: 'proprietary',
    pricing: { input: 3.88, output: 23.25 },
    scores: {
      artificialAnalysis: { intelligence: 55, speed: 140 },
    },
    categories: ['reasoning', 'context'],
    highlights: ['Max Effort Terra'],
  },
  {
    id: 'gpt-5-6-luna-max',
    ...
    maxOutput: 128000,
    license: 'proprietary',
    pricing: { input: 1.55, output: 9.34 },
    scores: {
      artificialAnalysis: { intelligence: 51, speed: 188 },
      vellum: { swebench: 93, terminal: 84.3 },
    },
    categories: ['coding', 'context'],
    highlights: ['Max Effort Luna'],
  },
  {
    ...
    scores: {
      artificialAnalysis: { intelligence: 54, speed: 59 },
    },
    categories: ['reasoning', 'context'],
    highlights: ['Medium Effort Sol'],
  },
  {
    id: 'gpt-5-3-codex',
    name: 'GPT-5.3 Codex',
    ...
    maxOutput: 128000,
    license: 'proprietary',
    pricing: { input: 3, output: 18 },
    scores: {
      artificialAnalysis: { intelligence: 44, speed: 133 },
      vellum: { swebench: 91 },
    },
    categories: ['coding', 'price'],
    highlights: ['Code-Focused Model'],
  },
  {
    ...
    scores: {
      artificialAnalysis: { intelligence: 45, speed: 192 },
    },
    categories: ['speed', 'price', 'context'],
    highlights: ['Balanced Flash Tier'],
  },
  {
    ...
    scores: {
      artificialAnalysis: { intelligence: 36, speed: 449 },
    },
    categories: ['speed', 'price', 'context'],
    highlights: ['Ultra-Fast Flash'],
  },
  {
    id: 'gemma-4-31b',
    name: 'Gemma 4 31B',
    ...
    scores: {
      artificialAnalysis: { intelligence: 29, speed: 35 },
    },
    categories: ['openSource', 'local', 'price'],
    highlights: ['Google Open Source', 'Self-Hostable'],
  },
  {
    ...
    maxOutput: 32000,
    license: 'proprietary',
    pricing: { input: 0.375, output: 2.25 },
    scores: {
      artificialAnalysis: { intelligence: 25, speed: 303 },
    },
    categories: ['speed', 'price', 'context'],
    highlights: ['Cheapest Gemini'],
  },
  {
    id: 'qwen3-6-plus',
    name: 'Qwen3.6 Plus',
    ...
    pricing: { input: 0.5, output: 2 },
    scores: {
      artificialAnalysis: { intelligence: 40, speed: 53 },
    },
    categories: ['openSource', 'price', 'reasoning'],
    highlights: ['Budget Alibaba Flagship'],
  },
  {
    id: 'qwen3-7-plus',
    name: 'Qwen3.7 Plus',
    ...
    scores: {
      artificialAnalysis: { intelligence: 39, speed: 53 },
    },
    categories: ['openSource', 'price'],
    highlights: ['Mid-Range Alibaba'],
  },
  {
    id: 'qwen3-6-27b',
    name: 'Qwen3.6 27B',
    ...
    scores: {
      artificialAnalysis: { intelligence: 37, speed: 57 },
    },
    categories: ['openSource', 'local', 'price'],
    highlights: ['Small Open Source'],
  },
  {
    id: 'qwen3-5-397b',
    name: 'Qwen3.5 397B',
    ...
    maxOutput: 32000,
    license: 'open',
    pricing: { input: 0.33, output: 1.32 },
    scores: {
      artificialAnalysis: { intelligence: 34, speed: 68 },
    },
    categories: ['openSource', 'price'],
    highlights: ['Large Open Source'],
  },
  {
    id: 'nemotron-3-ultra',
    ...
    pricing: { input: 0.5, output: 2 },
    scores: {
      artificialAnalysis: { intelligence: 38, speed: 186 },
    },
    categories: ['openSource', 'speed', 'price'],
    highlights: ['NVIDIA Open Model', 'Fast Open Source'],
  },
  {
    ...
    scores: {
      artificialAnalysis: { intelligence: 30, speed: 76 },
    },
    categories: ['price'],
    highlights: ['Mid-Range European AI'],
  },
  {
    id: 'mistral-small-4',
    ...
    scores: {
      artificialAnalysis: { intelligence: 20, speed: 162 },
    },
    categories: ['openSource', 'price', 'speed'],
    highlights: ['Cheapest European AI'],
  },
  {
    id: 'claude-4-5-haiku',
    ...
    scores: {
      artificialAnalysis: { intelligence: 30, speed: 105 },
      vellum: { gpqa: 92.1 },
    },
    categories: ['speed', 'price'],
    highlights: ['Fastest Claude', 'Budget Anthropic'],
  },
  {
    id: 'mercury-2',
    name: 'Mercury 2',
    ...
    pricing: { input: 0.5, output: 2 },
    scores: {
      artificialAnalysis: { intelligence: 21, speed: 982 },
    },
    categories: ['speed', 'price'],
    highlights: ['Fastest Non-Google Model'],
  },
  {
    id: 'mimo-v2-5-pro',
    name: 'MiMo-V2.5-Pro',
    ...
    scores: {
      artificialAnalysis: { intelligence: 42, speed: 67 },
    },
    categories: ['openSource', 'coding', 'price'],
    highlights: ['Xiaomi Flagship Model'],
  },
  {
    id: 'llama-4-maverick',
    ...
    scores: {
      artificialAnalysis: { intelligence: 14, speed: 110 },
    },
    categories: ['openSource', 'context', 'price'],
    highlights: ['Ultra Budget Open Source'],
  },
  {
    id: 'command-a-plus',
    name: 'Command A+',
    ...
    pricing: { input: 0.15, output: 0.6 },
    scores: {
      artificialAnalysis: { intelligence: 23, speed: 189 },
    },
    categories: ['openSource', 'speed', 'price'],
    highlights: ['Cohere Flagship'],
  },
];
